...
('32178954E', 'Isabel', 'Fernández', '600222333', (SELECT id_usuario FROM Usuario WHERE nombre_usuario = 'ifernandez')),
('78965412F', 'Ricardo', 'Santos', '600444555', (SELECT id_usuario FROM Usuario WHERE nombre_usuario = 'rsantos')),
('45632187G', 'Sofía', 'Ramírez', '600666777', (SELECT id_usuario FROM Usuario WHERE nombre_usuario = 'sramirez')),
('98712365H', 'Andrés', 'Hernández', '600999888', (SELECT id_usuario FROM Usuario WHERE nombre_usuario = 'ahernandez')),
('56473829I', 'Mónica', 'Navarro', '600111999', (SELECT id_usuario FROM Usuario WHERE nombre_usuario = 'mnavarro')),
...
('Ana', 'Fernández', '2014-03-22', 'mensual', 'activo', 3, 5),
('Juan', 'Santos', '2016-07-10', 'semanal', 'activo', 4, 6),
('Maria', 'Ramírez', '2017-02-28', 'mensual', 'activo', 5, 7),
('Pedro', 'Hernández', '2016-11-05', 'trimestral', 'activo', 1, 8),
...
INSERT IGNORE INTO Actividad (nombre_actividad, descripcion) VALUES ('Presentacion Monster', 'Esta actividad se realizará en el aula, donde los monitores darán la bienvenida a los niños y niñas. Se les invita a acomodarse en semicírculo en el suelo, junto al narrador de cuentos. El narrador contará la historia de la creación de Monster a los niños y niñas.');
...
INSERT IGNORE INTO Actividad (nombre_actividad, descripcion) VALUES ('Super Slime', 'La actividad se llevará a cabo en el patio central, brindando a los niños y niñas un espacio amplio y cómodo para expresarse libremente. Antes de comenzar, se presentarán los materiales y se formularán preguntas para activar sus conocimientos previos. Luego, se les animará a crear un slime gigante de manera colaborativa, asegurando que todos participen. Al finalizar, se pondrá música para enriquecer la experiencia, permitiendo que los niños y niñas manipulen el slime mientras realizan movimientos con sus extremidades.');
...
('2025-06-02', '2025-06-29', 8),  -- Ana Fernández
('2025-06-02', '2025-06-08', 9),  -- Juan Santos
('2025-06-02', '2025-06-29', 10), -- Maria Ramírez
('2025-06-02', '2025-08-31', 11), -- Pedro Hernández
